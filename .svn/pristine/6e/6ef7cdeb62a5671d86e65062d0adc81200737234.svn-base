...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					<tbody>
					<tr><th colspan="5">订单编号：<s:property value="model.oid"/></th></tr>
					<tr>
						<th>图片</th>
						<th>商品</th>
						<th>价格</th>
						...
						<s:iterator value="model.orderItemSet" var="orderItem">
							<tr>
								<td width="60">
				...
				<div class="span24">
					<p>
							...
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="<s:property value="model.user.name"/>" style="width:150px" />
								<br /> 
							联系方式：<input type="text" name="phone" value="<s:property value="model.user.phone"/>" style="width:150px"/> 
