...
$(function(){
	...
	$("#checkImg").click(function(){
		this.src="${pageContext.request.contextPath}/checkImg.action?t="+new Date().getTime();
	});
});
</script>
</head>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<div style="width: 400px;background: #fff8db;border: 1px solid white;font-size: 18px;color: red;"><s:fielderror/><s:actionmessage /></div>
					<form id="registerForm" action="${pageContext.request.contextPath }/user_register.action" method="post" novalidate="novalidate"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="password" name="rePassword"
										id="rePassword" class="text" maxlength="20" autocomplete="off"/></td>
								</tr>
								<tr>
								...
								<tr>
									<th>地址:</th>
									<td><input type="text" name="addr" id="addr" class="
										text"
										maxlength="200"/></td>
								</tr>
								<tr>
