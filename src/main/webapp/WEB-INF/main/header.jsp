	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/index">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.png" alt="非非商城"/>
			</a>
		</div>
	</div>
	<div class="span9">
		<div>
			<img src="${pageContext.request.contextPath}/image/header.jpg" style="padding-top:8px"" width="320" height="50" alt="正品保障" title="正品保障"/>
		</div>
	</div>
